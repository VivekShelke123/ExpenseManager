...
var ExpenseDetails_1 = require("../models/ExpenseDetails");
var axios_1 = require("axios");
var mongoose_1 = require("mongoose");
var addExpenseDetail = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, userName, time, date, month, year, category, spentOn, amount, remark, expenseData, data, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, userName = _a.userName, time = _a.time, date = _a.date, month = _a.month, year = _a.year, category = _a.category, spentOn = _a.spentOn, amount = _a.amount, remark = _a.remark;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                expenseData = new ExpenseDetails_1.default({ userName: userName, time: time, date: date, month: month, year: year, category: category, spentOn: spentOn, amount: amount, remark: remark });
                return [4 /*yield*/, expenseData.save()];
            case 2:
                data = _b.sent();
...
var getExpenseDetails = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, ExpenseDetails_1.default.find({ userName: userName })];
            case 2:
                data = _a.sent();
                res.send(data);
                return [3 /*break*/, 4];
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, ExpenseDetails_1.default.findOne({ _id: element._id })];
            case 4:
                newFindData = _b.sent();
...
var deleteEntry = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, ExpenseDetails_1.default.findByIdAndDelete(objectId)];
            case 2:
                findData = _a.sent();
                if (findData) {
...
exports.default = { addExpenseDetail: addExpenseDetail, getExpenseDetails: getExpenseDetails, updateAmount: updateAmount, deleteEntry: deleteEntry };
